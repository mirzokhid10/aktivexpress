            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="partner-box">
                        <?= \yii\bootstrap5\Html::img('@web/assets/logos/partner_hamkorbank.png', ['alt' => 'logo', 'class' => 'birun-service-icon']) ?>
                        <p class="birun-partner-title">Hamkor Bank</p>
                        <p class="birun-partner-link"><a href="https://hamkorbank.uz" target="_blank">hamkorbank.uz</a></p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="partner-box">
