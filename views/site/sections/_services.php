        ...
        <div class="col-md-5">
            <div class="card h100-p rounded-2">
                <div class="card-body text-center text-sm-start text-md-start">
                    ...
                    <p class="birun-gray-text w70-p mb-md-0 mb-lg-1"><?= Yii::t('serv', 'Your parcel will be delivered without damage or harm.') ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="card h100-p rounded-2">
                <div class="card-body text-center text-sm-start text-md-start">
                    ...
                    <p class="birun-gray-text w70-p mb-md-0 mb-lg-1"><?= Yii::t('serv', 'Payment can be made by the sender or the recipient.') ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card h100-p rounded-2">
                <div class="card-body text-center text-sm-start text-md-start">
                    ...
                    <p class="birun-gray-text w70-p mb-md-0 mb-lg-1 mb-0"><?= Yii::t('serv', 'We will pick up your parcel from you or deliver it directly to the address.') ?></p>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h100-p rounded-2">
                <div class="card-body text-center text-sm-start text-md-start">
                    ...
                    <p class="birun-gray-text w70-p mb-md-0 mb-lg-1"><?= Yii::t('serv', 'We deliver your large cargo quickly and reliably.') ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-5">
            <div class="card h100-p rounded-2">
                <div class="card-body text-center text-sm-start text-md-start">
                    ...
                    <p class="birun-gray-text w70-p mb-md-0 mb-lg-1"><?= Yii::t('serv', 'Delivery is more profitable with us!') ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-7">
